...
TelnyxResource.prototype = {
  ...
  _request: function(method, host, path, data, auth, options, callback) {
    ...
    const APPLY_CUSTOM_DATAPROCESSOR_TO_REQUEST = 'Apply-Custom-DataProcessor-To-Request';
    if (self.requestDataProcessor && options.headers[APPLY_CUSTOM_DATAPROCESSOR_TO_REQUEST]) {
      delete options.headers[APPLY_CUSTOM_DATAPROCESSOR_TO_REQUEST];
