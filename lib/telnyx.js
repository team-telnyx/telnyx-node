...
var resources = {
  ...
  NotificationEventConditions: require('./resources/NotificationEventConditions'),
  ...
  NotificationProfiles: require('./resources/NotificationProfiles'),
  SimCardGroups: require('./resources/SimCardGroups'),
  NumberLookup: require('./resources/NumberLookup'),
  NotificationEvents: require('./resources/NotificationEvents'),
  NotificationChannels: require('./resources/NotificationChannels.js'),
  NotificationSettings: require('./resources/NotificationSettings.js'),
