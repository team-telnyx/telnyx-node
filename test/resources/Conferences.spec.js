...
describe('Calls Resource', function() {
  describe('Call Conferences', function() {
    ...
    describe('retrieve', function() {
      ...
      it('Sends the correct request [with specified auth]', function() {
        return telnyx.conferences.retrieve(CONFERENCE_ID, TEST_AUTH_KEY)
          .then(responseFn);
      });
    });
    ...
    describe('participants', function() {
      ...
      it('Sends the correct request', function() {
        return telnyx.conferences.participants(CONFERENCE_ID, {filter: {muted: true}})
          .then(responseFn);
      });

      it('Sends the correct request [with specified auth]', function() {
        return telnyx.conferences.participants(CONFERENCE_ID, TEST_AUTH_KEY)
          .then(responseFn);
      });
    });
