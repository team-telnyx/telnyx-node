...
const fuse = new Fuse(
  [
    ...
    'client.enterprises.reputation.create',
    'client.enterprises.reputation.deleteAll',
    'client.enterprises.reputation.list',
    'client.enterprises.reputation.updateFrequency',
    'client.enterprises.reputation.numbers.create',
    'client.enterprises.reputation.numbers.delete',
