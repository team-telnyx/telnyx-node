...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Telnyx)`
    : `const run: (${functionSource.client}: Telnyx) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.ai.retrieveConversationHistories',
    'client.ai.summarize',
    ...
    'client.ai.missions.cloneMission',
    'client.ai.missions.create',
    'client.ai.missions.deleteMission',
    'client.ai.missions.list',
    'client.ai.missions.listEvents',
    'client.ai.missions.retrieve',
    'client.ai.missions.updateMission',
    'client.ai.missions.runs.cancelRun',
    'client.ai.missions.runs.create',
    'client.ai.missions.runs.list',
    'client.ai.missions.runs.listRuns',
    'client.ai.missions.runs.pauseRun',
    'client.ai.missions.runs.resumeRun',
    'client.ai.missions.runs.retrieve',
    'client.ai.missions.runs.update',
    'client.ai.missions.runs.events.getEventDetails',
    'client.ai.missions.runs.events.list',
    'client.ai.missions.runs.events.log',
    'client.ai.missions.runs.plan.addStepsToPlan',
    'client.ai.missions.runs.plan.create',
    'client.ai.missions.runs.plan.getStepDetails',
    'client.ai.missions.runs.plan.retrieve',
    'client.ai.missions.runs.plan.updateStep',
    'client.ai.missions.runs.telnyxAgents.link',
    'client.ai.missions.runs.telnyxAgents.list',
    'client.ai.missions.runs.telnyxAgents.unlink',
    'client.ai.missions.knowledgeBases.createKnowledgeBase',
    'client.ai.missions.knowledgeBases.deleteKnowledgeBase',
    'client.ai.missions.knowledgeBases.getKnowledgeBase',
    'client.ai.missions.knowledgeBases.listKnowledgeBases',
    'client.ai.missions.knowledgeBases.updateKnowledgeBase',
    'client.ai.missions.mcpServers.createMcpServer',
    'client.ai.missions.mcpServers.deleteMcpServer',
    'client.ai.missions.mcpServers.getMcpServer',
    'client.ai.missions.mcpServers.listMcpServers',
    'client.ai.missions.mcpServers.updateMcpServer',
    'client.ai.missions.tools.createTool',
    'client.ai.missions.tools.deleteTool',
    'client.ai.missions.tools.getTool',
    'client.ai.missions.tools.listTools',
    'client.ai.missions.tools.updateTool',
    ...
    'client.calls.actions.addAIAssistantMessages',
    ...
    'client.calls.actions.startConversationRelay',
    ...
    'client.calls.actions.stopConversationRelay',
    ...
    'client.conferences.retrieveParticipant',
    'client.conferences.updateParticipant',
    'client.conferences.actions.endConference',
    'client.conferences.actions.gatherDtmfAudio',
    ...
    'client.conferences.actions.sendDtmf',
    ...
    'client.speechToText.retrieveTranscription',
    ...
    'client.storage.kvs.create',
    'client.storage.kvs.delete',
    'client.storage.kvs.list',
    'client.storage.kvs.retrieve',
    'client.storage.kvs.keys.delete',
    'client.storage.kvs.keys.list',
    'client.storage.kvs.keys.retrieve',
    'client.storage.kvs.keys.update',
    'client.storage.cloudfs.create',
    'client.storage.cloudfs.delete',
    'client.storage.cloudfs.list',
    'client.storage.cloudfs.retrieve',
    'client.storage.cloudfs.update',
    'client.storage.cloudfs.actions.rotateMetaToken',
    ...
    'client.texml.accounts.queues.create',
    'client.texml.accounts.queues.delete',
    'client.texml.accounts.queues.list',
    'client.texml.accounts.queues.retrieve',
    'client.texml.accounts.queues.update',
    ...
    'client.mobilePhoneNumbers.retrieve',
    'client.mobilePhoneNumbers.update',
    'client.mobilePhoneNumbers.messaging.list',
    'client.mobilePhoneNumbers.messaging.retrieve',
    'client.mobileVoiceConnections.create',
    'client.mobileVoiceConnections.delete',
    'client.mobileVoiceConnections.list',
    'client.mobileVoiceConnections.retrieve',
    'client.mobileVoiceConnections.update',
    'client.messaging10dlc.getEnum',
    ...
    'client.organizations.users.actions.remove',
    ...
    'client.whatsapp.businessAccounts.delete',
    'client.whatsapp.businessAccounts.list',
    'client.whatsapp.businessAccounts.retrieve',
    'client.whatsapp.businessAccounts.phoneNumbers.initializeVerification',
    'client.whatsapp.businessAccounts.phoneNumbers.list',
    'client.whatsapp.businessAccounts.settings.retrieve',
    'client.whatsapp.businessAccounts.settings.update',
    ...
    'client.whatsapp.phoneNumbers.profile.retrieve',
    'client.whatsapp.phoneNumbers.profile.update',
    ...
    'client.voiceClones.downloadSample',
    'client.voiceClones.list',
    'client.voiceClones.update',
    'client.voiceDesigns.create',
    'client.voiceDesigns.delete',
    'client.voiceDesigns.deleteVersion',
    'client.voiceDesigns.downloadSample',
    'client.voiceDesigns.list',
    'client.voiceDesigns.rename',
    'client.voiceDesigns.retrieve',
    'client.trafficPolicyProfiles.create',
    'client.trafficPolicyProfiles.delete',
    'client.trafficPolicyProfiles.list',
    'client.trafficPolicyProfiles.listServices',
    'client.trafficPolicyProfiles.retrieve',
    'client.trafficPolicyProfiles.update',
    'client.enterprises.brandedCalling',
    'client.enterprises.create',
    'client.enterprises.delete',
    'client.enterprises.list',
    'client.enterprises.retrieve',
    'client.enterprises.update',
    'client.enterprises.reputation.disable',
    'client.enterprises.reputation.enable',
    'client.enterprises.reputation.retrieve',
    ...
    'client.enterprises.reputation.numbers.refresh',
    'client.enterprises.reputation.numbers.retrieve',
    'client.enterprises.reputation.loa.render',
    'client.enterprises.reputation.loa.update',
    'client.enterprises.reputation.remediation.create',
    'client.enterprises.reputation.remediation.list',
    'client.enterprises.reputation.remediation.retrieve',
    'client.enterprises.dir.create',
    ...
    'client.termsOfService.agreements.retrieve',
    'client.termsOfService.brandedCalling.agree',
    'client.pronunciationDicts.create',
    'client.pronunciationDicts.delete',
    ...
    'client.dir.submit',
    'client.dir.update',
    'client.dir.updateInfringement',
    'client.dir.comments.create',
    'client.dir.comments.list',
    'client.dir.phoneNumberBatches.list',
    'client.dir.phoneNumberBatches.retrieve',
    'client.dir.phoneNumbers.add',
    'client.dir.phoneNumbers.list',
    'client.dir.phoneNumbers.remove',
    'client.dir.references.create',
    'client.dir.references.list',
    'client.dir.references.update',
    'client.dir.verifyEmail.confirm',
    'client.dir.verifyEmail.create',
