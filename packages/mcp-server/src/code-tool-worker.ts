...
const fuse = new Fuse(
  [
    ...
    'client.ai.assistants.tags.create',
    'client.ai.assistants.tags.delete',
    ...
    'client.whatsapp.businessAccounts.phoneNumbers.createVerification',
    ...
    'client.whatsapp.messageTemplates.create',
    'client.whatsapp.messageTemplates.delete',
    'client.whatsapp.messageTemplates.list',
    'client.whatsapp.messageTemplates.retrieve',
    'client.whatsapp.messageTemplates.update',
    ...
    'client.x402.creditAccount.createPaymentQuote',
    'client.x402.creditAccount.settlePayment',
