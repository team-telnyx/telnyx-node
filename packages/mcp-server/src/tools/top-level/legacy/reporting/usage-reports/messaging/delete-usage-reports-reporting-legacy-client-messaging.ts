...
export const tool: Tool = {
  name: 'delete_usage_reports_reporting_legacy_client_messaging',
  description:
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.client.legacy.reporting.usageReports.messaging.delete(id)),
  );
};
