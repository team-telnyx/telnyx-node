...
export const tool: Tool = {
  name: 'list_batch_detail_records_reporting_legacy_client_speech_to_text',
  description:
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.client.legacy.reporting.batchDetailRecords.speechToText.list()),
  );
};
