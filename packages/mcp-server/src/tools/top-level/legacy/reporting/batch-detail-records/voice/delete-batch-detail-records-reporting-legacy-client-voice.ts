...
export const tool: Tool = {
  name: 'delete_batch_detail_records_reporting_legacy_client_voice',
  description:
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.client.legacy.reporting.batchDetailRecords.voice.delete(id)),
  );
};
