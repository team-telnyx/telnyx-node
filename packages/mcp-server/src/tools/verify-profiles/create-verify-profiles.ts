  ...
  inputSchema: {
    ...
    properties: {
      ...
      sms: {
        ...
        required: ['whitelisted_destinations'],
      },
      webhook_failover_url: {
        type: 'string',
      },
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.verifyProfiles.create(body)));
};
