...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['allowed_grant_types', 'allowed_scopes', 'client_type', 'name'],
  },
  annotations: {},
};
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.oauthClients.create(body)));
};
