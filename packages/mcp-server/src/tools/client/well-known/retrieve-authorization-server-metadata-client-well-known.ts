...
export const tool: Tool = {
  name: 'retrieve_authorization_server_metadata_client_well_known',
  description:
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.client.wellKnown.retrieveAuthorizationServerMetadata()),
  );
};
