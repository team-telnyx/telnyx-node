...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['id', 'wireless_blocklist_id'],
  },
  annotations: {},
};
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.simCardGroups.actions.setWirelessBlocklist(id, body)),
    );
  } catch (error) {
