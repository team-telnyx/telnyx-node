...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['range', 'starting_number'],
  },
  annotations: {},
};
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.numberBlockOrders.create(body)));
};
