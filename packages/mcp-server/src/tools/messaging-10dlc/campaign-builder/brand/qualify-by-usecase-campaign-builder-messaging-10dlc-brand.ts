...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(
        jq_filter,
        await client.messaging10dlc.campaignBuilder.brand.qualifyByUsecase(usecase, body),
      ),
    );
  } catch (error) {
