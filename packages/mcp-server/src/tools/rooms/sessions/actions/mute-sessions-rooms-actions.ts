...
export const tool: Tool = {
  name: 'mute_sessions_rooms_actions',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nMute participants in room session.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/action_mute_response',\n  $defs: {\n    action_mute_response: {\n      type: 'object',\n      properties: {\n        data: {\n          type: 'object',\n          properties: {\n            result: {\n              type: 'string'\n            }\n          }\n        }\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      room_session_id: {
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.rooms.sessions.actions.mute(room_session_id, body)),
  );
};
