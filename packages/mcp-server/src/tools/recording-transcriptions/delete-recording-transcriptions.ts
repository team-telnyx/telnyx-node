...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.recordingTranscriptions.delete(recording_transcription_id)),
    );
  } catch (error) {
