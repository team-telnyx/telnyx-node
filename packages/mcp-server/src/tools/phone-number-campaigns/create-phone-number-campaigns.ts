...
export const tool: Tool = {
  name: 'create_phone_number_campaigns',
  description:
  ...
  inputSchema: {
    ...
    required: ['campaignId', 'phoneNumber'],
  },
  annotations: {},
};
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.phoneNumberCampaigns.create(body)));
  } catch (error) {
