...
export const tool: Tool = {
  name: 'retrieve_usage_reports_reporting_legacy_number_lookup',
  description:
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.legacy.reporting.usageReports.numberLookup.retrieve(id)),
    );
  } catch (error) {
