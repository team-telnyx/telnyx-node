...
export const tool: Tool = {
  name: 'retrieve_batch_detail_records_reporting_legacy_messaging',
  description:
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.legacy.reporting.batchDetailRecords.messaging.retrieve(id)),
    );
  } catch (error) {
