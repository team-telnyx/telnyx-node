...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['sim_card_id', 'threshold'],
  },
  annotations: {},
};
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.simCardDataUsageNotifications.create(body)),
  );
};
