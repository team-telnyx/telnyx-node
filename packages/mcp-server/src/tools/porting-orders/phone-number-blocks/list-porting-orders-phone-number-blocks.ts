        ...
        properties: {
          ...
          status: {
            anyOf: [
              {
                type: 'string',
                title: 'porting_order_single_status',
              ...
              },
              {
                ...
                items: {
                  type: 'string',
                  title: 'porting_order_status_list',
                  enum: [
                    'draft',
                    'in-process',
                    'submitted',
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.portingOrders.phoneNumberBlocks.list(porting_order_id, body).asResponse();
  try {
