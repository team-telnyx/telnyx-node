...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.portingOrders.phoneNumberConfigurations.list(body).asResponse();
  try {
