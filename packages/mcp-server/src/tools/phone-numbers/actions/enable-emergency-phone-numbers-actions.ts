...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['id', 'emergency_address_id', 'emergency_enabled'],
  },
  annotations: {},
};
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.phoneNumbers.actions.enableEmergency(id, body)),
    );
  } catch (error) {
