  ...
  inputSchema: {
    ...
    properties: {
      ...
      sort: {
        ...
        enum: ['created_at', 'friendly_name', 'active'],
      },
      jq_filter: {
        type: 'string',
        title: 'jq Filter',
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.texmlApplications.list(body)));
};
