...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['network_id', 'region_code'],
  },
  annotations: {},
};
...
export const handler = async (client: Telnyx, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.wireguardInterfaces.create(body)));
  } catch (error) {
