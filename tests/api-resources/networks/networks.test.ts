...
describe('resource networks', () => {
  ...
  test.skip('update: only required params', async () => {
    const responsePromise = client.networks.update('6a09cdc3-8948-47f0-aa62-74ac943d6c58', { name: 'test network' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.networks.update('6a09cdc3-8948-47f0-aa62-74ac943d6c58', { name: 'test network' });
  });
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.networks.list({
  ...
  test.skip('listInterfaces: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.networks.listInterfaces('6a09cdc3-8948-47f0-aa62-74ac943d6c58', {
