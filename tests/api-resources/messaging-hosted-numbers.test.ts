...
describe('resource messagingHostedNumbers', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.messagingHostedNumbers.retrieve('id');
  ...
  test.skip('update', async () => {
    const responsePromise = client.messagingHostedNumbers.update('id', {});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list', async () => {
    const responsePromise = client.messagingHostedNumbers.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.messagingHostedNumbers.list({
