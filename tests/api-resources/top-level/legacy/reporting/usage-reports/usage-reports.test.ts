...
describe('resource usageReports', () => {
  ...
  test.skip('retrieveSpeechToText', async () => {
    const responsePromise = client.client.legacy.reporting.usageReports.retrieveSpeechToText();
  ...
  test.skip('retrieveSpeechToText: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.client.legacy.reporting.usageReports.retrieveSpeechToText(
