...
describe('resource conferences', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.conferences.create({ call_control_id: 'v3:MdI91X4lWFEs7IgbBEOT9M4AigoY08M0WWZFISt1Yw2axZ_IiE4pqg', name: 'Business' });
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.conferences.retrieve('id', { region: 'Australia' }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.conferences.list({
    filter: {
  ...
  test.skip('listParticipants: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.conferences.listParticipants('conference_id', {
    filter: {
    muted: true,
    on_hold: true,
    whispering: true,
  ...
  test.skip('retrieveParticipant: only required params', async () => {
    const responsePromise = client.conferences.retrieveParticipant('participant_id', { id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveParticipant: required and optional params', async () => {
    const response = await client.conferences.retrieveParticipant('participant_id', { id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });
  });

  // Mock server tests are disabled
  test.skip('updateParticipant: only required params', async () => {
    const responsePromise = client.conferences.updateParticipant('participant_id', { id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
