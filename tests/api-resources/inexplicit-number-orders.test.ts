...
describe('resource inexplicitNumberOrders', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.inexplicitNumberOrders.create({ ordering_groups: [{
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.inexplicitNumberOrders.list({ page_number: 1, page_size: 1 }, { path: '/_stainless_unknown_path' }))
      .rejects
