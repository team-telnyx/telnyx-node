...
describe('resource subNumberOrders', () => {
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.subNumberOrders.retrieve('sub_number_order_id', { filter: { include_phone_numbers: true } }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.subNumberOrders.list({ filter: {
    country_code: 'US',
  ...
  test.skip('updateRequirementGroup: only required params', async () => {
    const responsePromise = client.subNumberOrders.updateRequirementGroup('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { requirement_group_id: 'a4b201f9-8646-4e54-a7d2-b2e403eeaf8c' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('updateRequirementGroup: required and optional params', async () => {
    const response = await client.subNumberOrders.updateRequirementGroup('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { requirement_group_id: 'a4b201f9-8646-4e54-a7d2-b2e403eeaf8c' });
  });
});
