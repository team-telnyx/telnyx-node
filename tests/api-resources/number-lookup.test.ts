...
describe('resource numberLookup', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.numberLookup.retrieve('+18665552368');
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.numberLookup.retrieve('+18665552368', { type: 'carrier' }, { path: '/_stainless_unknown_path' }))
      .rejects
