...
describe('resource portingOrders', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.portingOrders.create({ phone_numbers: ['+13035550000', '+13035550001', '+13035550002'] });
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.portingOrders.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { include_phone_numbers: true }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.portingOrders.list({
    filter: {
    activation_settings: {
  ...
  test.skip('retrieveAllowedFocWindows', async () => {
    const responsePromise = client.portingOrders.retrieveAllowedFocWindows('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveLoaTemplate: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.portingOrders.retrieveLoaTemplate('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { loa_configuration_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Telnyx.NotFoundError);
  });
  ...
  test.skip('retrieveRequirements: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.portingOrders.retrieveRequirements('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { 'page[number]': 0, 'page[size]': 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Telnyx.NotFoundError);
  });
