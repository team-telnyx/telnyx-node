...
describe('resource customerServiceRecords', () => {
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.customerServiceRecords.list({
    filter: {
  ...
  test.skip('verifyPhoneNumberCoverage: only required params', async () => {
    const responsePromise = client.customerServiceRecords.verifyPhoneNumberCoverage({ phone_numbers: ['+13035553000'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('verifyPhoneNumberCoverage: required and optional params', async () => {
    const response = await client.customerServiceRecords.verifyPhoneNumberCoverage({ phone_numbers: ['+13035553000'] });
  });
});
