...
describe('resource actions', () => {
  ...
  test.skip('acceptSuggestions', async () => {
    const responsePromise = client.addresses.actions.acceptSuggestions('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test.skip('acceptSuggestions: request options and params are passed correctly', async () => {
    ...
    await expect(client.addresses.actions.acceptSuggestions('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { id: 'id' }, { path: '/_stainless_unknown_path' }))
      .rejects
