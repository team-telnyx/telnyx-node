...
describe('resource rcs', () => {
  ...
  test.skip('generateDeeplink: request options and params are passed correctly', async () => {
    ...
    await expect(client.messages.rcs.generateDeeplink('agent_id', { body: 'body', phone_number: 'phone_number' }, { path: '/_stainless_unknown_path' }))
      .rejects
