...
describe('resource actions', () => {
  ...
  test.skip('bridge: only required params', async () => {
    const responsePromise = client.calls.actions.bridge('call_control_id', { call_control_id_to_bridge_with: 'v3:MdI91X4lWFEs7IgbBEOT9M4AigoY08M0WWZFISt1Yw2axZ_IiE4pqg' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('gatherUsingAI: only required params', async () => {
    const responsePromise = client.calls.actions.gatherUsingAI('call_control_id', { parameters: {
    properties: 'bar',
    required: 'bar',
    type: 'bar',
  } });
  ...
  test.skip('gatherUsingAI: required and optional params', async () => {
    ...
    language: 'en',
    message_history: [{ content: 'Hello, what\'s your name?', role: 'assistant' }, { content: 'Hello, I\'m John.', role: 'user' }],
  ...
  test.skip('gatherUsingSpeak: only required params', async () => {
    const responsePromise = client.calls.actions.gatherUsingSpeak('call_control_id', { payload: 'say this on call', voice: 'male' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('refer: only required params', async () => {
    const responsePromise = client.calls.actions.refer('call_control_id', { sip_address: 'sip:username@sip.non-telnyx-address.com' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('refer: required and optional params', async () => {
    ...
    client_state: 'aGF2ZSBhIG5pY2UgZGF5ID1d',
    command_id: '891510ac-f3e4-11e8-af5b-de00688a4901',
    custom_headers: [{ name: 'head_1', value: 'val_1' }, { name: 'head_2', value: 'val_2' }],
  ...
  test.skip('sendSipInfo: only required params', async () => {
    const responsePromise = client.calls.actions.sendSipInfo('call_control_id', { body: '{"key": "value", "numValue": 100}', content_type: 'application/json' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('speak: only required params', async () => {
    const responsePromise = client.calls.actions.speak('call_control_id', { payload: 'Say this on the call', voice: 'female' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('startRecording: only required params', async () => {
    const responsePromise = client.calls.actions.startRecording('call_control_id', { channels: 'single', format: 'wav' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('transfer: only required params', async () => {
    const responsePromise = client.calls.actions.transfer('call_control_id', { to: '+18005550100 or sip:username@sip.telnyx.com' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('transfer: required and optional params', async () => {
    ...
    webhook_urls: { 'call.answered': 'https://www.example.com/webhooks/answered', 'call.hangup': 'https://www.example.com/webhooks/hangup' },
  ...
  test.skip('updateClientState: only required params', async () => {
    const responsePromise = client.calls.actions.updateClientState('call_control_id', { client_state: 'aGF2ZSBhIG5pY2UgZGF5ID1d' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('updateClientState: required and optional params', async () => {
    const response = await client.calls.actions.updateClientState('call_control_id', { client_state: 'aGF2ZSBhIG5pY2UgZGF5ID1d' });
  });
});
