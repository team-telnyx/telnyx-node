...
describe('resource wireguardPeers', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.wireguardPeers.create({ wireguard_interface_id: '6a09cdc3-8948-47f0-aa62-74ac943d6c58' });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.wireguardPeers.create({ wireguard_interface_id: '6a09cdc3-8948-47f0-aa62-74ac943d6c58' });
  });
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.wireguardPeers.list({
