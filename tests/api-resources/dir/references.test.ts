...
describe('resource references', () => {
  ...
  test.skip('submit: only required params', async () => {
    const responsePromise = client.dir.references.submit('16635d38-75a6-4481-82e8-69af60e05011', {
      business_references: [
        {
          email: 'dana.reyes@example.com',
          full_name: 'Dana Reyes',
  ...
  test.skip('submit: required and optional params', async () => {
    const response = await client.dir.references.submit('16635d38-75a6-4481-82e8-69af60e05011', {
      business_references: [
        {
          email: 'dana.reyes@example.com',
          full_name: 'Dana Reyes',
