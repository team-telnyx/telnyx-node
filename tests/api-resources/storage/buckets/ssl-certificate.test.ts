...
describe('resource sslCertificate', () => {
  ...
  test.skip('create: request options and params are passed correctly', async () => {
    ...
    await expect(client.storage.buckets.sslCertificate.create('', { certificate: await toFile(Buffer.from('Example data'), 'README.md'), private_key: await toFile(Buffer.from('Example data'), 'README.md') }, { path: '/_stainless_unknown_path' }))
      .rejects
