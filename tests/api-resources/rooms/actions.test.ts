...
describe('resource actions', () => {
  ...
  test.skip('generateJoinClientToken', async () => {
    const responsePromise = client.rooms.actions.generateJoinClientToken('0ccc7b54-4df3-4bca-a65a-3da1ecc777f0', {});
  ...
  test.skip('refreshClientToken: required and optional params', async () => {
    const response = await client.rooms.actions.refreshClientToken('0ccc7b54-4df3-4bca-a65a-3da1ecc777f0', { refresh_token: 'eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9..gNEwzTow5MLLPLQENytca7pUN79PmPj6FyqZWW06ZeEmesxYpwKh0xRtA0TzLh6CDYIRHrI8seofOO0YFGDhpQ', token_ttl_secs: 600 });
  });
});
