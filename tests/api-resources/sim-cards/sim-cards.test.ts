...
describe('resource simCards', () => {
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.simCards.retrieve('6a09cdc3-8948-47f0-aa62-74ac943d6c58', { include_pin_puk_codes: true, include_sim_card_group: true }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.simCards.list({
    filter: {
  ...
  test.skip('delete: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.simCards.delete('6a09cdc3-8948-47f0-aa62-74ac943d6c58', { report_lost: true }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Telnyx.NotFoundError);
  });
  ...
  test.skip('listWirelessConnectivityLogs', async () => {
    const responsePromise = client.simCards.listWirelessConnectivityLogs('6a09cdc3-8948-47f0-aa62-74ac943d6c58');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listWirelessConnectivityLogs: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.simCards.listWirelessConnectivityLogs('6a09cdc3-8948-47f0-aa62-74ac943d6c58', { 'page[number]': 1, 'page[size]': 1 }, { path: '/_stainless_unknown_path' }))
      .rejects
      .toThrow(Telnyx.NotFoundError);
  });
});
