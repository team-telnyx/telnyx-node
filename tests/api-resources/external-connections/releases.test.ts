...
describe('resource releases', () => {
  ...
  test.skip('retrieve: only required params', async () => {
    const responsePromise = client.externalConnections.releases.retrieve('7b6a6449-b055-45a6-81f6-f6f0dffa4cc6', { id: '1293384261075731499' });
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.externalConnections.releases.retrieve('7b6a6449-b055-45a6-81f6-f6f0dffa4cc6', { id: '1293384261075731499' });
  });
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    ...
    await expect(client.externalConnections.releases.list('1293384261075731499', {
    filter: {
