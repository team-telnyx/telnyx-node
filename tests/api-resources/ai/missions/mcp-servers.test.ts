...
describe('resource mcpServers', () => {
  ...
  test.skip('deleteMcpServer: only required params', async () => {
    const responsePromise = client.ai.missions.mcpServers.deleteMcpServer('mcp_server_id', { mission_id: 'mission_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('deleteMcpServer: required and optional params', async () => {
    const response = await client.ai.missions.mcpServers.deleteMcpServer('mcp_server_id', { mission_id: 'mission_id' });
  });

  // Mock server tests are disabled
  test.skip('getMcpServer: only required params', async () => {
    const responsePromise = client.ai.missions.mcpServers.getMcpServer('mcp_server_id', { mission_id: 'mission_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getMcpServer: required and optional params', async () => {
    const response = await client.ai.missions.mcpServers.getMcpServer('mcp_server_id', { mission_id: 'mission_id' });
  });
  ...
  test.skip('updateMcpServer: only required params', async () => {
    const responsePromise = client.ai.missions.mcpServers.updateMcpServer('mcp_server_id', { mission_id: 'mission_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('updateMcpServer: required and optional params', async () => {
    const response = await client.ai.missions.mcpServers.updateMcpServer('mcp_server_id', { mission_id: 'mission_id' });
  });
});
