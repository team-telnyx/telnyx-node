...
describe('resource insightGroups', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.ai.conversations.insightGroups.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test.skip('update', async () => {
    const responsePromise = client.ai.conversations.insightGroups.update('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('delete', async () => {
    const responsePromise = client.ai.conversations.insightGroups.delete('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveInsightGroups: request options and params are passed correctly', async () => {
    ...
    await expect(client.ai.conversations.insightGroups.retrieveInsightGroups({ 'page[number]': 0, 'page[size]': 0 }, { path: '/_stainless_unknown_path' }))
      .rejects
