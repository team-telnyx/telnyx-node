...
describe('resource assistants', () => {
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(client.ai.assistants.retrieve('assistant_id', {
  ...
  test.skip('chat: only required params', async () => {
    const responsePromise = client.ai.assistants.chat('assistant_id', { content: 'Tell me a joke about cats', conversation_id: '42b20469-1215-4a9a-8964-c36f66b406f4' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('imports: only required params', async () => {
    const responsePromise = client.ai.assistants.imports({ api_key_ref: 'api_key_ref', provider: 'elevenlabs' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
