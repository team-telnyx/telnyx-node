...
describe('resource usageReports', () => {
  ...
  test.skip('retrieveSpeechToText: request options and params are passed correctly', async () => {
    ...
    await expect(client.legacy.reporting.usageReports.retrieveSpeechToText({ end_date: '2020-07-01T00:00:00-06:00', start_date: '2020-07-02T00:00:00-06:00' }, { path: '/_stainless_unknown_path' }))
      .rejects
