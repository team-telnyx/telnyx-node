...
export class InexplicitNumberOrders extends APIResource {
  ...
  list(
    ...
    options?: RequestOptions,
  ): APIPromise<InexplicitNumberOrderListResponse> {
    return this._client.get('/inexplicit_number_orders', { query, ...options });
  }
}

export interface InexplicitNumberOrderCreateResponse {
  data?: InexplicitNumberOrderCreateResponse.Data;
}

export namespace InexplicitNumberOrderCreateResponse {
  export interface Data {
    ...
    ordering_groups?: Array<Data.OrderingGroup>;
...
export namespace InexplicitNumberOrderRetrieveResponse {
  export interface Data {
    /**
     * Unique identifier for the inexplicit number order
     */
...
export interface InexplicitNumberOrderListResponse {
  data?: Array<InexplicitNumberOrderListResponse.Data>;

  meta?: AuthenticationProvidersAPI.PaginationMeta;
}

export namespace InexplicitNumberOrderListResponse {
  export interface Data {
    /**
     * Unique identifier for the inexplicit number order
     */
