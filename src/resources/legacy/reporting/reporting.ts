...
import { UsageReportRetrieveSpeechToTextParams, UsageReportRetrieveSpeechToTextResponse, UsageReports } from './usage-reports/usage-reports';

export class Reporting extends APIResource {
  batchDetailRecords: BatchDetailRecordsAPI.BatchDetailRecords = new BatchDetailRecordsAPI.BatchDetailRecords(this._client);
...
export declare namespace Reporting {
  export {
    BatchDetailRecords as BatchDetailRecords,
