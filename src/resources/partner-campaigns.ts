...
import * as CampaignAPI from './number-10dlc/campaign/campaign';
...
export class PartnerCampaigns extends APIResource {
   ...
   * for await (const telnyxDownstreamCampaign of client.partnerCampaigns.list()) {
   *   // ...
   * }
   * ```
   */
   ...
   * ```ts
   * // Automatically fetches more pages as needed.
   * for await (const partnerCampaignListSharedByMeResponse of client.partnerCampaigns.listSharedByMe()) {
   *   // ...
   * }
   * ```
   */
