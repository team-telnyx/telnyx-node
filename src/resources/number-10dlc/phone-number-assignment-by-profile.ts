...
export class PhoneNumberAssignmentByProfile extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.number10dlc.phoneNumberAssignmentByProfile.assign(
   *     {
   *       messagingProfileId:
   ...
   * ```ts
   * const response =
   *   await client.number10dlc.phoneNumberAssignmentByProfile.getPhoneNumberStatus(
   *     'taskId',
   *   );
   * ```
   */
  getPhoneNumberStatus(
    taskID: string,
    query: PhoneNumberAssignmentByProfileGetPhoneNumberStatusParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse> {
   ...
   * ```ts
   * const response =
   *   await client.number10dlc.phoneNumberAssignmentByProfile.getTaskStatus(
   *     'taskId',
   *   );
   * ```
   */
  getTaskStatus(
    taskID: string,
    options?: RequestOptions,
  ): APIPromise<PhoneNumberAssignmentByProfileGetTaskStatusResponse> {
...
export interface PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse {
  records: Array<PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse.Record>;
}

export namespace PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse {
...
export interface PhoneNumberAssignmentByProfileGetTaskStatusResponse {
  /**
   * An enumeration.
   */
...
export interface PhoneNumberAssignmentByProfileGetPhoneNumberStatusParams {
  page?: number;
