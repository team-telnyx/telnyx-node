...
export class MessagingProfiles extends APIResource {
  ...
  ): PagePromise<MessagingMessagingProfilesDefaultFlatPagination, MessagingMessagingProfile> {
    return this._client.getAPIList('/messaging_profiles', DefaultFlatPagination<MessagingMessagingProfile>, {
      query,
      ...options,
    });
  }
...
export type MessagingMessagingProfilesDefaultFlatPagination =
  DefaultFlatPagination<MessagingMessagingProfile>;
