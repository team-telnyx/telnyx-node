...
export class OAuthClients extends APIResource {
   ...
   * @example
   * ```ts
   * const oauthClient = await client.client.oauthClients.create(
   *   {
   ...
   * ```ts
   * const oauthClient =
   *   await client.client.oauthClients.retrieve(
   ...
   * @example
   * ```ts
   * const oauthClient = await client.client.oauthClients.update(
   *   '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
   * );
   * ```
   */
   ...
   * ```ts
   * const oauthClients =
   *   await client.client.oauthClients.list();
   * ```
   */
  list(
   ...
   * @example
   * ```ts
   * await client.client.oauthClients.delete(
   *   '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
   * );
   * ```
   */
