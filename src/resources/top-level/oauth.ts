...
export class OAuth extends APIResource {
   ...
   * @example
   * ```ts
   * const oauth = await client.client.oauth.retrieve(
   *   'consent_token',
   * );
   * ```
   */
   ...
   * @example
   * ```ts
   * const response = await client.client.oauth.grants({
   *   allowed: true,
   ...
   * @example
   * ```ts
   * const response = await client.client.oauth.introspect({
   *   token: 'token',
   * });
   * ```
   */
   ...
   * @example
   * ```ts
   * const response = await client.client.oauth.register();
   * ```
   */
   ...
   * @example
   * ```ts
   * await client.client.oauth.retrieveAuthorize({
   *   client_id: 'client_id',
   ...
   * @example
   * ```ts
   * const response = await client.client.oauth.retrieveJwks();
   * ```
   */
...
export interface ConsentTokenResponse {
  data?: ConsentTokenResponse.Data;
}

export namespace ConsentTokenResponse {
...
export interface OAuthDynamicRegistrationResponse {
  /**
...
export interface JWKSet {
  keys?: Array<JWKSet.Key>;
}

export namespace JWKSet {
