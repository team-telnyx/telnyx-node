...
export class Voice extends APIResource {
   ...
   * ```ts
   * const voice =
   *   await client.client.legacy.reporting.usageReports.voice.create(
   *     {
   ...
   * ```ts
   * const voice =
   *   await client.client.legacy.reporting.usageReports.voice.retrieve(
   ...
   * ```ts
   * const voices =
   *   await client.client.legacy.reporting.usageReports.voice.list();
   * ```
   */
  list(
   ...
   * ```ts
   * const voice =
   *   await client.client.legacy.reporting.usageReports.voice.delete(
   *     '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
   *   );
   * ```
   */
...
export interface CdrPostUsageReportResponse {
  /**
   * Legacy V2 CDR usage report response
   */
  data?: CdrPostUsageReportResponse.Data;
}

export namespace CdrPostUsageReportResponse {
  /**
   * Legacy V2 CDR usage report response
   */
...
export interface CdrGetUsageReportByIdResponse {
  /**
   * Legacy V2 CDR usage report response
   */
  data?: CdrGetUsageReportByIdResponse.Data;
}

export namespace CdrGetUsageReportByIdResponse {
  /**
   * Legacy V2 CDR usage report response
   */
  export interface Data {
...
export interface CdrGetUsageReportsResponse {
  data?: Array<CdrGetUsageReportsResponse.Data>;

  meta?: CdrGetUsageReportsResponse.Meta;
}

export namespace CdrGetUsageReportsResponse {
  /**
   * Legacy V2 CDR usage report response
   */
  export interface Data {
...
export interface CdrDeleteUsageReportResponse {
  /**
   * Legacy V2 CDR usage report response
   */
  data?: CdrDeleteUsageReportResponse.Data;
}

export namespace CdrDeleteUsageReportResponse {
  /**
   * Legacy V2 CDR usage report response
   */
  export interface Data {
