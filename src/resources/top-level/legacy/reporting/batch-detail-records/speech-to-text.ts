...
export class SpeechToText extends APIResource {
   ...
   * ```ts
   * const speechToText =
   *   await client.client.legacy.reporting.batchDetailRecords.speechToText.create(
   *     {
   ...
   * ```ts
   * const speechToText =
   *   await client.client.legacy.reporting.batchDetailRecords.speechToText.retrieve(
   ...
   * ```ts
   * const speechToTexts =
   *   await client.client.legacy.reporting.batchDetailRecords.speechToText.list();
   * ```
   */
   ...
   * ```ts
   * const speechToText =
   *   await client.client.legacy.reporting.batchDetailRecords.speechToText.delete(
   *     '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
   *   );
   * ```
   */
...
export interface SttPostDetailReportResponse {
  data?: SttPostDetailReportResponse.Data;
}

export namespace SttPostDetailReportResponse {
...
export interface SttGetDetailReportByIdResponse {
  data?: SttGetDetailReportByIdResponse.Data;
}

export namespace SttGetDetailReportByIdResponse {
  export interface Data {
    /**
     * Identifies the resource
     */
...
export interface SttGetDetailReportResponse {
  data?: Array<SttGetDetailReportResponse.Data>;
}

export namespace SttGetDetailReportResponse {
  export interface Data {
    /**
     * Identifies the resource
     */
...
export interface SttDeleteDetailReportResponse {
  data?: SttDeleteDetailReportResponse.Data;
}

export namespace SttDeleteDetailReportResponse {
  export interface Data {
    /**
     * Identifies the resource
     */
