...
export class OAuthGrants extends APIResource {
   ...
   * @example
   * ```ts
   * const oauthGrant = await client.client.oauthGrants.retrieve(
   ...
   * @example
   * ```ts
   * const oauthGrants = await client.client.oauthGrants.list();
   * ```
   */
  list(
   ...
   * @example
   * ```ts
   * const oauthGrant = await client.client.oauthGrants.delete(
   *   '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
   * );
   * ```
   */
...
export interface unnamed_schema_6 {
  data?: unnamed_schema_6.Data;
}

export namespace unnamed_schema_6 {
  export interface Data {
    /**
     * Unique identifier for the OAuth grant
     */
