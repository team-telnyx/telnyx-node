...
import * as FqdnAuthenticationAPI from './fqdn-authentication';
import {
  FqdnAuthentication,
...
export class FqdnConnections extends APIResource {
  fqdnAuthentication: FqdnAuthenticationAPI.FqdnAuthenticationResource =
    new FqdnAuthenticationAPI.FqdnAuthenticationResource(this._client);
...
FqdnConnections.FqdnAuthenticationResource = FqdnAuthenticationResource;
...
export declare namespace FqdnConnections {
  ...
  export {
    FqdnAuthenticationResource as FqdnAuthenticationResource,
