...
export class PartnerCampaigns extends APIResource {
  ...
  list(query: PartnerCampaignListParams | null | undefined = {}, options?: RequestOptions): PagePromise<TelnyxDownstreamCampaignsPerPagePaginationV2, TelnyxDownstreamCampaign> {
    return this._client.getAPIList('/10dlc/partner_campaigns', PerPagePaginationV2<TelnyxDownstreamCampaign>, { query, ...options });
  }
  ...
  listSharedByMe(query: PartnerCampaignListSharedByMeParams | null | undefined = {}, options?: RequestOptions): PagePromise<PartnerCampaignListSharedByMeResponsesPerPagePaginationV2, PartnerCampaignListSharedByMeResponse> {
    return this._client.getAPIList('/10dlc/partnerCampaign/sharedByMe', PerPagePaginationV2<PartnerCampaignListSharedByMeResponse>, { query, ...options });
  }
...
export type PartnerCampaignRetrieveSharingStatusResponse = { [key: string]: CampaignAPI.CampaignSharingStatus }
